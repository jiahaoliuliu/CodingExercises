...
class FizzBuzz {
    ...
    private fun fizzBuzzOneLine(n: Int): List<String> {
    ...
    @Test
    fun testFizzBuzzOneLine1() {
        // Given
        val n = 3

        // When
        val result = fizzBuzzOneLine(n)
    ...
    private fun fizzBuzzAppend(n: Int): List<String> {
        // Create the content and loop through
    ...
    @Test
    fun testFizzBuzzAppend1() {
        // Given
        val n = 3

        // When
        val result = fizzBuzzAppend(n)
