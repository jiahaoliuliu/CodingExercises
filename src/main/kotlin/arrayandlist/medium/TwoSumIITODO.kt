...
class TwoSumIITODO {
     ...
     * Initial thoughts
     *
     * The constraint here is the space complexity
     * Since the space complexity is 1, we cannot use a hashmap
     * But since the items are sorted, probably we can use a sliding windows
     *
     * 1. Init the elements
     * left = 0
     * right = length - 1
     ...
     *
     *  3. Return
     *  If the solution was not found, return empty int array
     */
