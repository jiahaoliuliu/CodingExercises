 ...
 */
class PathCrossingTODO {
    /**
     * Initial thoughts
     *
     * Set initial point to Pair(0, 0)
     *
     * Decode each value of the string
     * 1. DecodeDirection(dir: Char, origin: Pair(Int, Int)): Pair(Int, Int)
     *  -> N (i, j+1)
     *  -> S (i, j -1)
     *  -> W (i - 1, j)
     *  -> E (i + 1, j)
     * Create a list of points visited.
     * For new point, if it has not been visited, add it
