...
class ValidateBinarySearchTreeAsList: ValidateBinarySearchTree() {

    /**
     * A valid BST could be serialized as a list of strictly increasing elements
     * With this logic, the algo could go thought the list from left, until
     * it finds the first node, the compare them back
     */
    override fun isValidBST(root: TreeNode?): Boolean {
        return true
    }
